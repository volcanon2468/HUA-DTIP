...
def _build_pamap2_columns():
    ...
    for loc in ["hand", "chest", "ankle"]:
        base += [
            f"{loc}_temp",
            f"{loc}_acc_16_x", f"{loc}_acc_16_y", f"{loc}_acc_16_z",
            f"{loc}_acc_6_x", f"{loc}_acc_6_y", f"{loc}_acc_6_z",
            f"{loc}_gyro_x", f"{loc}_gyro_y", f"{loc}_gyro_z",
            f"{loc}_mag_x", f"{loc}_mag_y", f"{loc}_mag_z",
            f"{loc}_orient_w", f"{loc}_orient_x", f"{loc}_orient_y", f"{loc}_orient_z",
        ]
    return base
